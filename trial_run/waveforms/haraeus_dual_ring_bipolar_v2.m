function  stimulation_table = haraeus_dual_ring_bipolar_v2(train_interval_on, train_interval_off, amplitude, duration, asynch_frequency)
...
n_programs      = 2;
n_repeats       = train_interval_on * asynch_frequency;
wait_time       = 0; 1000/frequency/n_programs - 1;

electrode_configuration = {'Dual_ring_bipolar'}; % Needs to be a cell for the table entry below
stimulation_table       = [];
